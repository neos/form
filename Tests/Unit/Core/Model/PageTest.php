...
class PageTest extends UnitTestCase
{
    ...
    public function getElementsRecursivelyReturnsFirstLevelFormElements()
    {
        ...
        $element1 = $this->getMockBuilder(AbstractFormElement::class)->onlyMethods([])->disableOriginalConstructor()->getMock();
        /** @var AbstractFormElement|MockObject $element2 */
        $element2 = $this->getMockBuilder(AbstractFormElement::class)->onlyMethods([])->disableOriginalConstructor()->getMock();
    ...
    public function getElementsRecursivelyReturnsRecursiveFormElementsInCorrectOrder()
    {
        ...
        $element2 = $this->getMockBuilder(Section::class)->onlyMethods([])->disableOriginalConstructor()->getMock();
        /** @var AbstractFormElement|MockObject $element21 */
        $element21 = $this->getMockBuilder(AbstractFormElement::class)->onlyMethods([])->disableOriginalConstructor()->getMock();
        /** @var AbstractFormElement|MockObject $element22 */
        $element22 = $this->getMockBuilder(AbstractFormElement::class)->onlyMethods([])->disableOriginalConstructor()->getMock();
        $element2->addElement($element21);
        $element2->addElement($element22);
        /** @var AbstractFormElement|MockObject $element3 */
        $element3 = $this->getMockBuilder(AbstractFormElement::class)->onlyMethods([])->disableOriginalConstructor()->getMock();
    ...
    public function aFormElementCanOnlyBeAttachedToASinglePage()
    {
        ...
        $element = $this->getMockBuilder(AbstractFormElement::class)->onlyMethods([])->disableOriginalConstructor()->getMock();
